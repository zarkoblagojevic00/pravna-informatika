...
(deffunction translate-strictrule (?rule-file ?strictrule-string)
	...
	; Build support rule
	(bind $?object-vars0 (get-object-address-vars-2 $?cond-without-strong-negation)) ; PROOF
	(bind $?support-rule (create$
;		"(" ntm-aggregateattrule (sym-cat ?strictrule-name "-support") 
		"(" ntm-derivedattrule (sym-cat ?strictrule-name "-support") 
...
;			?var1 <- (insert$ $?actual-conclusion (length$ $?actual-conclusion) (create$ "(" ?support-slot ?var3 "&" ":" "(" not "(" member$ ?strictrule-name ?var3 ")" ")" ")" ))
			?var1 <- (insert$ $?actual-conclusion (length$ $?actual-conclusion) (create$ "(" ?support-slot ?var3 "&" ":" "(" not "(" subseq-pos "(" create$ ?strictrule-name $?object-vars0 $$$ ?var3 ")" ")" ")" ")" )) ; PROOF
			"(" test "(" eq "(" class ?var1 ")" ?conclusion-class ")" ")"
		=> 
;		   	?var1 <- "(" ?conclusion-class "(" ?support-slot "(" list ?strictrule-name ")" ")" ")" ; PROOF
		   	"(" calc "(" bind ?var6 "(" create$ ?strictrule-name $?object-vars0 ?var3 ")" ")" ")"
		   	?var1 <- "(" ?conclusion-class "(" ?support-slot ?var6 ")" ")"
		")"
	))
...
;		"(" ntm-aggregateattrule (sym-cat ?defeasiblerule-name "-support") 
		"(" ntm-derivedattrule (sym-cat ?defeasiblerule-name "-support") 
...
;			?var1 <- (insert$ $?actual-conclusion (length$ $?actual-conclusion) (create$ "(" ?support-slot ?var3 "&" ":" "(" not "(" member$ ?defeasiblerule-name ?var3 ")" ")" ")" ))
			?var1 <- (insert$ $?actual-conclusion (length$ $?actual-conclusion) (create$ "(" ?support-slot ?var3 "&" ":" "(" not "(" subseq-pos "(" create$ ?defeasiblerule-name $?object-vars0 $$$ ?var3 ")" ")" ")" ")" )) ; PROOF
			"(" test "(" eq "(" class ?var1 ")" ?conclusion-class ")" ")"
		=> 
;		   	?var1 <- "(" ?conclusion-class "(" ?support-slot "(" list ?defeasiblerule-name ")" ")" ")"
		   	"(" calc "(" bind ?var6 "(" create$ ?defeasiblerule-name $?object-vars0 ?var3 ")" ")" ")"
		   	?var1 <- "(" ?conclusion-class "(" ?support-slot ?var6 ")" ")"
		")"
	))
	(printout ?rule-file (str-cat$ $?support-rule) crlf)
